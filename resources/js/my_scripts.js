...
function loadPlayersPage() {
	...
	for (var i = 0; i < players.length; i++){
		...
		a.href = "#";
		a.innerHTML = players[i].name;
		a.index = i;
		a.onclick = function() {switchPlayers(this.index)};
		player_selector.appendChild(a);
		player_selector.appendChild(br);
	}
}
...
function switchPlayers(playerNum) {
	...
	// Calculated values
	var av_pass = player.pass_yards/player.games_played;
	var av_r = player.rushing_yards/player.games_played;
	var av_rec = player.receiving_yards/player.games_played;

	document.getElementById("avg_p_yards").innerHTML = av_pass.toFixed(2);
	document.getElementById("avg_r_yards").innerHTML = av_r.toFixed(2);
	document.getElementById("avg_rec_yards").innerHTML = av_rec.toFixed(2);
}
